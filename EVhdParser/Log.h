...
#define LOG_CTG_ALL (LOG_CTG_GENERAL | LOG_CTG_PARSER | LOG_CTG_CIPHER | LOG_CTG_DISPATCH)
#define LOG_CTG_DEFAULT (LOG_CTG_GENERAL | LOG_CTG_PARSER | LOG_CTG_CIPHER | LOG_CTG_DISPATCH)
